...
import static assimp.Config.NO_VALIDATEDS_PROCESS;
import assimp.GenericProperty;
import assimp.processes.ValidateDSProcess;
import assimp.components.AiScene;
import static assimp.importing.AiPostProcessSteps.*;
import static assimp.importing.ImporterRegistry.getImporterInstanceList;
import assimp.processes.BaseProcess;
import static assimp.processes.PostStepRegistry.getPostProcessingStepInstanceList;
import assimp.processes.ScenePreprocessor;
import java.io.File;
