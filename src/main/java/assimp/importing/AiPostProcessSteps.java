...
public enum AiPostProcessSteps {
     ...
     * importer property,
     * <tt>#AI_CONFIG_PP_CT_MAX_SMOOTHING_ANGLE</tt>, which allows you to
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>Identifies and joins identical vertex data sets within all imported
     * meshes.
     *
     ...
     * property, <tt>#AI_CONFIG_PP_RVC_FLAGS</tt>. This is quite useful if you
     ...
     * <tt>#AI_CONFIG_PP_SLM_TRIANGLE_LIMIT</tt>
     * importer properties. The default values are
     * <tt>#AI_SLM_DEFAULT_MAX_VERTICES</tt> and
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>Removes the node graph and pre-transforms all vertices with the local
     ...
     * artifacts are rare.
     *
     * @note The <tt>#AI_CONFIG_PP_PTV_NORMALIZE</tt> configuration property can
     ...
     * interest to you. The <tt>#AI_CONFIG_PP_ICL_PTCACHE_SIZE</tt>
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>This step tries to determine which meshes have normal vectors that
     ...
     * <tt>#AI_CONFIG_PP_SBP_REMOVE</tt> importer property to specify which
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>This step searches all meshes for degenerate primitives and converts
     ...
     * </li>
     * <li>Set the <tt>#AI_CONFIG_PP_FD_REMOVE</tt> importer property to 1. This
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>This step searches all meshes for invalid data, such as zeroed normal
     ...
     * by the #aiProcess_GenSmoothNormals flag.<br>
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>This step converts non-UV mappings (such as spherical or cylindrical
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>This step applies per-texture UV transformations and bakes them into
    ...
    // -------------------------------------------------------------------------
    /**
     * <hr>This step searches for duplicate meshes and replaces them with
